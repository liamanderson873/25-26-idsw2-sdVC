...
Esta carpeta contiene el análisis MVC (Model-View-Controller) de cada caso de uso especificado para el sistema Jorgestor.
...
- [CU-38 Importar Asignaturas](CU-38-importarAsignaturas/)
- [CU-39 Importar Grados](CU-39-importarGrados/)
- [CU-40 Exportar Asignaturas](CU-40-exportarAsignaturas/)
- [CU-41 Exportar Grados](CU-41-exportarGrados/)
...
- **colaboracion.puml**: Diagrama de colaboración PlantUML entre clases de análisis.
